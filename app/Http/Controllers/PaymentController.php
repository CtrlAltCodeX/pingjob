...
class PaymentController extends Controller
{
    ...
    public function checkout($id = null)
    {
        ...
        return view('frontend.checkout', compact('title', 'package'));
    }
    ...
    public function payment($transaction_id = null)
    {
        ...
        $title = __('app.pay');
        return view('frontend.payment', compact('title', 'payment'));
    }
    ...
    public function paymentSuccess($transaction_id = null)
    {
        ...
        return view('frontend.notice', compact('title', 'type', 'msg'));
    }
    ...
    public function paymentCancelled($transaction_id = null)
    {
        ...
        return view('frontend.notice', compact('title', 'msg'));
    }
