...
class PostController extends Controller
{
    ...
    public function uploadFeatureImage($request){
        ...
        if ($request->hasFile('feature_image')){
            ...
            $imageName = strtolower(time().Str::random(5).'-'.Functions::str_slug($file_base_name)).'.' . $image->getClientOriginalExtension();
    ...
    public function view($slug){
        ...
        $title = $post->title;
        return view('frontend.blog-view', compact('title', 'post'));
    }
