...
<div class="row" style="border: 1px solid #00000020;">
    ...
    <div class="col-md-12">
        ...
        <a href="{{ route('job_id_download_resume_zip', $job_id) . '?page=' . $applications->currentPage() }}" class="btn btn-success m-2">Download listed resumes</a>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-6 d-flex p-1 px-3" style="border: 1px solid rgba(0, 0, 0, 0.125); font-weight: 600;">
                <div style="width: 40%;" class="d-flex flex-column align-items-center justify-content-around">
                    ...
                    <p class="text-muted"><i class="la la-download"></i> <a href="{{ route('download_resume', $application->resume) }}">Download Resume </a>
                    </p>
                </div>
                <div style="width: 60%">
                    <p class="text-muted"><i class="la la-user"></i> Rank: {{ $application->resume_score??0 }}</p>
                    ...
                    <form action="{{ route('delete_application') }}" method="post">
                        ...
                        <button type="submit" class="btn btn-danger btn-sm m-1 px-4"><i class="la la-trash-o"></i></button>
                    </form>
                    @endif
                </div>
