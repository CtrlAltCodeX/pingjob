...
@endsection
@section('content')
    <div class="row" class="row" style="border: 1px solid #00000020;">
        @php
            $employer = auth()->user();
        @endphp
        @if ($employer->premium_jobs_balance)
            ...
            <div class="col-md-12">
                @if ($applications->count())
                    <a href="{{ route('download_resume_zip') . '?page=' . $applications->currentPage() }}"
                            ...
                            <div class="col-12 col-lg-6 d-flex p-1 px-3"
                                ...
                                <div style="width: 40%;"
                                    ...
                                    <p class="text-muted"><i class="la la-download"></i> <a
                                            href="{{ route('download_resume', $application->resume) }}">Download Resume </a>
                                    </p>
                                </div>
                                <div style="width: 60%">
                                    ...
                                    <p class="text-muted"><i class="la la-phone-square"></i>
