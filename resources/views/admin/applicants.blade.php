                    ...
                    @foreach ($applications as $application)
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- <p class="text-muted"><i class="la la-download"></i> <a href="{{ $application->job_id . '/getDownload/' . $application->resume }}">Download Resume </a></p> -->



                                <p class="text-muted"><i class="la la-download"></i> <a
                                        href="{{ route('download_resume', $application->resume) }}">Download Resume </a></p>
                                ...
                                @if (!empty($application->job->job_title))
                                    <p>
                                        ...
                                        <a href="{{ route('job_view', $application->job->job_slug) }}"
                                            target="_blank">{{ $application->job->job_title }}</a>
                            ...
                            <td>
                                ...
                                @if (!$application->is_shortlisted)
                                    <a href="{{ route('make_short_list', $application->id) }}" class="btn btn-success"><i
                                            class="la la-user-plus"></i> @lang('app.shortlist') </a>
                                @else
