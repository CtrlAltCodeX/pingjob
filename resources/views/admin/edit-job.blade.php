...
@section('content')
    <div class="row">
        <div class="col-md-10">
            ...
            <form method="post" action="" id='form_edit_job'>
                @csrf

                <input type="hidden" required id="user_id" value="{{ $job->user_id }}" name="user_id">
                <input type="hidden" required id="email_send_to_applicants" value="no" name="email_send_to_applicants">
                <div class="form-group row {{ $errors->has('job_title') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control {{ e_form_invalid_class('job_title', $errors) }}"
                            id="job_title" value="{{ $job->job_title }}" name="job_title" placeholder="@lang('app.job_title')">
                ...
                <div class="form-group row {{ $errors->has('position') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control {{ e_form_invalid_class('position', $errors) }}"
                            id="position" value="{{ $job->position }}" name="position" placeholder="@lang('app.position')">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="price_input_group">
                            ...
                            <select class="form-control {{ e_form_invalid_class('salary_cycle', $errors) }}"
                                ...
                                <option value="daily" {{ selected('daily', $job->salary_cycle) }}>@lang('app.daily')
                                </option>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <input type="number" class="form-control {{ e_form_invalid_class('salary', $errors) }}"
                                    id="salary" value="{{ $job->salary }}" name="salary"
                                    placeholder="@lang('app.salary')">
                            </div>
                            <div class="col-md-6">
                ...
                <div class="form-group row {{ $errors->has('salary_upto') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control {{ e_form_invalid_class('salary_upto', $errors) }}"
                        ...
                        <div class="price_input_group">
                            ...
                            <select class="form-control {{ e_form_invalid_class('salary_currency', $errors) }}"
                                ...
                                @foreach (get_currencies() as $currency => $currency_name)
                                    <option value="{{ $currency }}" {{ selected($currency, $job->salary_currency) }}>
                ...
                <div class="form-group row {{ $errors->has('vacancy') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control {{ e_form_invalid_class('vacancy', $errors) }}"
                            id="vacancy" value="{{ $job->vacancy }}" name="vacancy" placeholder="@lang('app.vacancy')">
                ...
                <div class="form-group row {{ $errors->has('gender') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control {{ e_form_invalid_class('gender', $errors) }}" name="gender"
                            id="gender">
                ...
                <div class="form-group row {{ $errors->has('job_type') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control {{ e_form_invalid_class('job_type', $errors) }}" name="job_type"
                            ...
                            <option value="contract" {{ selected('contract', $job->job_type) }}>@lang('app.contract')
                            </option>
                ...
                <div class="form-group row {{ $errors->has('deadline') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-8">
                        <input type="text"
                            class="form-control {{ e_form_invalid_class('deadline', $errors) }} date_picker"
                            id="deadline"
                            value="{{ Carbon\Carbon::parse($job->deadline)->format('Y-m-d') }}"
                            name="deadline" placeholder="@lang('app.deadline')">
                ...
                @if ($user->is_admin())
                    <div class="form-group row {{ $errors->has('created_at') ? 'has-error' : '' }}">
                        <label for="created_at" class="col-sm-4 control-label"> @lang('app.created_at')</label>
                        <div class="col-sm-8">
                            <input type="text"
                                class="form-control {{ e_form_invalid_class('created_at', $errors) }} date_picker"
                                id="created_at" value="{{ $job->created_at->format('Y-m-d') }}" name="created_at"
                                placeholder="@lang('app.created_at')">

                            {!! e_form_error('created_at', $errors) !!}
                        </div>
                    </div>
                @endif
                ...
                <div class="form-group row {{ $errors->has('responsibilities') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-8">
                        <textarea name="responsibilities" class="form-control {{ e_form_invalid_class('responsibilities', $errors) }}"
                            rows="3">{!! $job->responsibilities !!}</textarea>
                        {!! $errors->has('responsibilities')
                            ? '<p class="help-block">' . $errors->first('responsibilities') . '</p>'
                            : '' !!}
                ...
                <div class="form-group row {{ $errors->has('educational_requirements') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-8">
                        <textarea name="educational_requirements"
                            class="form-control {{ e_form_invalid_class('educational_requirements', $errors) }}" rows="3">{!! $job->educational_requirements !!}</textarea>
                        {!! $errors->has('educational_requirements')
                            ? '<p class="help-block">' . $errors->first('educational_requirements') . '</p>'
                            : '' !!}
                ...
                <div class="form-group row {{ $errors->has('experience_requirements') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-8">
                        <textarea name="experience_requirements"
                            class="form-control {{ e_form_invalid_class('experience_requirements', $errors) }}" rows="3">{!! $job->experience_requirements !!}</textarea>
                        {!! $errors->has('experience_requirements')
                            ? '<p class="help-block">' . $errors->first('experience_requirements') . '</p>'
                            : '' !!}
                ...
                <div class="form-group row {{ $errors->has('additional_requirements') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-8">
                        <textarea name="additional_requirements"
                            class="form-control {{ e_form_invalid_class('additional_requirements', $errors) }}" rows="3">{!! $job->additional_requirements !!}</textarea>
                        {!! $errors->has('additional_requirements')
                            ? '<p class="help-block">' . $errors->first('additional_requirements') . '</p>'
                            : '' !!}
                ...
                <div class="form-group row {{ $errors->has('apply_instruction') ? 'has-error' : '' }}">
                    ...
                    <div class="col-sm-8">
                        <textarea name="apply_instruction" class="form-control {{ e_form_invalid_class('apply_instruction', $errors) }}"
                            rows="3">{!! $job->apply_instruction !!}</textarea>
                        {!! $errors->has('apply_instruction')
                            ? '<p class="help-block">' . $errors->first('apply_instruction') . '</p>'
                            : '' !!}
                    ...
                    <div class="col-md-8">
                        <select name="country"
                            ...
                            @foreach ($countries as $country)
                                <option value="{!! $country->id !!}" {{ selected($country->id, $job->country_id) }}>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <select name="state"
                            class="form-control {{ e_form_invalid_class('state', $errors) }} state_options state_to_city">
                            <option value="">Select a state</option>

                            @if ($old_country)
                                @foreach ($old_country->states as $state)
                                    <option value="{{ $state->id }}" {{ selected($state->id, $job->state_id) }}>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <select name="city" class="form-control  city_options">
                            <option value="">Select a city</option>

                            @if ($cities)
                                @foreach ($cities as $city)
                                    <option value="{{ $city['id'] }}" {{ selected($city['id'], $job->city_id) }}>
                                        {!! $city['name'] !!}</option>
                                @endforeach
                            @endif
                ...
                <div class="form-group row">
                    <label for="job_title" class="col-sm-4 control-label"> Pin Code</label>
                    <div class="col-sm-8">
                        <input type="number" required class="form-control" id="zip_code" value="{{ $job->zip_code }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        @if ($user->is_admin())
                            <button id='submit_button' class="btn btn-primary">@lang('app.update_job')</button>
                        @else
                            <button id='submit' class="btn btn-primary">@lang('app.update_job')</button>
                        @endif
                    </div>
                </div>
            </form>
