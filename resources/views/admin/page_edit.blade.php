        ...
        <div class="col-md-12">
            ...
            <form action="" method="post">
                ...
                <div class="form-group {{ $errors->has('title')? 'has-error':'' }}">
                    <div class="col-sm-12">
                        <input type="text" class="form-control {{e_form_invalid_class('title', $errors)}}" id="title" value="{{$page->title}}" name="title" placeholder="@lang('app.title')">
                ...
                <div class="form-group">
                    <div class="col-md-6">
                        <label for="show_in_header_menu" class="checkbox-inline">
                            <input type="checkbox" value="1" id="show_in_header_menu" name="show_in_header_menu" {{checked(1, $page->show_in_header_menu)}}>
                            @lang('app.show_in_header_menu')
                        </label>
                    </div>
                    <div class="col-md-6">
                        <label for="show_in_footer_menu" class="checkbox-inline">
                            <input type="checkbox" value="1" id="show_in_footer_menu" name="show_in_footer_menu" {{checked(1, $page->show_in_footer_menu)}}>
