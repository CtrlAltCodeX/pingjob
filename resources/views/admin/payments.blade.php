                    ...
                    @foreach ($payments as $payment)
                        <tr>
                            ...
                            <td><span data-toggle="tooltip"
                                    title="
                                {{ Carbon\Carbon::parse($payment->created_at)->format('F d, Y h:i a') }}">{{ Carbon\Carbon::parse($payment->created_at)->format('F d, Y h:i a') }}</span>
                            </td>
                            ...
                            <td>
                                ...
                                @else
                                    <span class="text-danger" data-toggle="tooltip" title="{{ $payment->status }}"><i
                                            class="la la-exclamation-circle"></i> </span>
                                @endif



                                <a href="{{ route('payment_view', $payment->id) }}" class="btn btn-success ml-2"><i
                                        class="la la-eye"></i> </a>
