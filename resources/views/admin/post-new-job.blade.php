...
@php
            ...
            <form method="post" action="">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                     <input type="text" class="form-control" id="clients_admin_dashboard" name="clients" >
                     <input type="hidden" class="form-control" id="client_admin_dashboard_id" name="client_id" >
                  </div>
              </div>
              ...
              @endif
                ...
                <div class="form-group row {{ $errors->has('experience_required_years')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <input type="number" min="0" max="20" class="form-control {{e_form_invalid_class('experience_required_years', $errors)}}" id="experience_required_years" value="{{ old('experience_required_years') }}" name="experience_required_years" placeholder="@lang('app.experience_required_years')">
                            </div>
                            <div class="col-md-6">
                ...
                <div class="form-group row {{ $errors->has('deadline')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-8">
                        <input type="date" required class="form-control {{e_form_invalid_class('deadline', $errors)}} date_picker" id="deadline" value="{{ old('deadline') }}" name="deadline" placeholder="@lang('app.deadline')">
...
<script src="https://code.jquery.com/ui/1.13.0/jquery-ui.js" defer></script>
  <script src="{{asset('assets/js/dashboard/post_jobs.js')}}" defer></script>
