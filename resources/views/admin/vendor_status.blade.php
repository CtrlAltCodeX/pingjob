...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <form method="POST" action="{{ route('dashboard_vendors_update') }}" enctype="multipart/form-data">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        @foreach($vendors as $vendor)
                            ...
                            <tr class="text-center">
                                ...
                                <td>{{ $vendor->employer }}</td>

                                <td>{{ $vendor->company }}</td>

                                <td class="text-left">{{  App\Helper\Functions::str_limit($vendor->website, $limit = 50, $end = '...') }}</td>

                                <td>@if($vendor->approve_status == 1) <span class="badge badge-success">Approved</span> @elseif($vendor->approve_status == 2)
                        ...
                        <tr>
                            ...
                            <td colspan="6" class="text-center"> No Vendors</td>
