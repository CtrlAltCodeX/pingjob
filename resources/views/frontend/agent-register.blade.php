                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="">
                            ...
                            <div class="form-group row">
                                <label for="website" class="col-md-4 col-form-label text-md-right">{{ __('app.website') }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name="state" class="form-control state_options state_to_city"  required autofocus>
