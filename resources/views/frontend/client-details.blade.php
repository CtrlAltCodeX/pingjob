        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="d-flex mb-2">
                    <img src="{{ $employer->logo ? asset('storage/uploads/images/logos/' . $employer->logo) : asset('assets/images/company.png') }}" style="display: inline-block; width:100px;">
                        ...
                        <h4> {{ $employer->company }}
                            ...
                            @for ($i = 0; $i < round($review_ratings); $i++) <span><i class="checked la la-star"></i></span>
                                ...
                                @for ($i = 0; $i < $review_total; $i++) <span><i class="unchecked la la-star"></i></span>
                                    ...
                                    @if ($review_count != 0)
                                    <a href="{{ route('user_reviews', ['job_id' => $employer->id, 'employer_id' => $employer->id]) }}" class="ml-2" style="font-size: 16px; color: rgb(0, 0, 0);">{{ $review_count }}
                ...
                <p>
                    ...
                    <a href="{{ route('reviews', ['employer_id' => $employer->id]) }}" class="btn btn-success"><i class="fa fa-star"></i>&nbsp;&nbsp;Write a Review</a>

                    <a data-toggle="modal" style="color:#fff;" data-target="#addVendorModal" class="btn btn-success"><i class="la la-plus"></i>Add Vendor&nbsp;&nbsp;</a>



                    <a data-toggle="modal" style="color:#fff;" data-target="#addContactModal" class="btn btn-success"><i class="la la-plus"></i>Add Contact&nbsp;&nbsp;</a>
                ...
                <div class="col-md-12">
                    ...
                    <div class="widget-box bg-white  mb-4 p-3 box-shadow">
                        ...
                        <h5>(
                            ...
                            <a href="{{ route('redirect-login', ['slug' => $employer->id, 'page' => 'client_details']) }}">Login</a>
                    ...
                    <div class="employer-job-listing mt-4">
                        ...
                        <table id="example" class="table table-striped responsive table-bordered nowrap">
                            ...
                            <tbody>
                                ...
                                @else
                                @if ($loop->index < 3) <tr class="text-center">
