            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="register-account-box jf-shadow p-3">
                        ...
                        <p class="icon"><img style=" max-width: 80px;" src="{{asset('assets/images/employee.png')}}"/> </p>
                ...
                <div class="col-md-4">
                    <div class="register-account-box jf-shadow  p-3">
                        ...
                        <p class="icon"><img  style="max-width: 80px;" src="{{asset('assets/images/enterprise.png')}}"/> </p>
                ...
                <div class="col-md-4">
                    <div class="register-account-box jf-shadow  p-3">
                        ...
                        <p class="icon"><img style="max-width: 80px;" src="{{asset('assets/images/agent.png')}}"/> </p>
