   ...
   <head>
     ...
     crossorigin="anonymous"></script>
      ...
      <style type='text/css'>
         ...
         div#searchCardBlock ,div#cityBlockCard,div#searchStateBlock,div#aboutUsCardArea,div#newJobPostedCard,div#topCLientCard,div#topVendorRowBlock,div#statesCardBlock{
      ...
      <div class="container-fluid mt-4">
         <div class="row">
            <div class="col col-sm-12 col-md-3 col-lg-3 col-xl-3">
               <div class="row" style="border-radius: 20px;margin-bottom: 24px;">
                  <div class="col-sm-12">
                     <div class="card"  id="searchCardBlock">
                        <div class="card-body">
               ...
               <div class="row" style="border-radius: 20px;margin-bottom: 24px;">
                  <div class="col-sm-12">
                     <div class="card"  id="searchStateBlock">
                        <div class="card-body">
               ...
               <div class="row mt-3" style="border-radius: 20px;margin-bottom: 24px;">
                  <div class="col-sm-12">
                     <div class="card" id="cityBlockCard">
                        <div class="card-body">
                           <div class="float-left">
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="card" id="aboutUsCardArea">
                        <div class="card-body mt-4" style="padding-bottom: 15px!important;">
            ...
            <div class="col col-sm-12 col-md-6 col-lg-6 col-xl-6">
               <div class="row" style="border-radius: 20px;margin-bottom: 24px;">
                  ...
                  <div class="col-sm-12">
                     <div class="card"  id="newJobPostedCard">
                        <div class="card-body">
                           <div class="float-left">
                              <h4 class="card-title">Newest jobs</h4>
                           </div>
               ...
               <div class="row mt-3" id="categoryMainRow">
                  <div class="col-sm-12">
                     <div class="card">
                        <div class="card-body">
                           @if($categories->count())
            ...
            <div class="col col-sm-12 col-md-3 col-lg-3 col-xl-3">
               <div class="row" style="border-radius: 20px;margin-bottom: 24px;">
                  <div class="card" id="topCLientCard">
                     <div class="card-body">
                        <div class="float-left">
                        ...
                        <div class="table-responsive1" style="padding-bottom: 10px;">
                           <table id="example1" >
               ...
               <div class="row mt-3" style="border-radius: 20px;margin-bottom: 24px;">
                  <div class="col-sm-12" style="padding: 0px;">
                     <div class="card"  id="topVendorRowBlock" >
                        <div class="card-body">
                           <div class="float-left">
               ...
               <!-- row end -->
               <div class="row mt-3" id="states"  style="border-radius: 20px;margin-bottom: 24px;">
                  <div class="col-sm-12" style="padding: 0px;">
                     <div class="card">
                        <div class="card-body" id="statesCardBlock">
                           <div class="float-left">
